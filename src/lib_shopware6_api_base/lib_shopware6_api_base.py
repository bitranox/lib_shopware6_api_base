...
class Shopware6StoreFrontClientBase:
    ...
    def _get_headers(self, update_header_fields: dict[str, str] | None = None) -> dict[str, str]:
        ...
        headers = {
            ...
            "sw-access-key": self.config.store_api_sw_access_key,
        }
...
class Shopware6AdminAPIClientBase:
    ...
    def _request_paginated(
        ...
        if _is_type_criteria(payload) and payload.ids:  # type: ignore
    ...
    @staticmethod
    def _get_headers(content_type: str = "json", update_header_fields: dict[str, str] | None = None) -> dict[str, str]:
        """
