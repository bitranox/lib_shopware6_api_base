...
long_description = "python3 base API client for shopware6"
...
setup_kwargs["name"] = "lib_shopware6_api_base"
setup_kwargs["version"] = "v2.0.7.3"
setup_kwargs["url"] = "https://github.com/bitranox/lib_shopware6_api_base"
setup_kwargs["packages"] = find_packages()
setup_kwargs["package_data"] = {"lib_shopware6_api_base": ["py.typed", "*.pyi", "__init__.pyi"]}
setup_kwargs["description"] = "python3 base API client for shopware6"
...
setup_kwargs["entry_points"] = {"console_scripts": ["lib_shopware6_api_base = lib_shopware6_api_base.lib_shopware6_api_base_cli:cli_main"]}
